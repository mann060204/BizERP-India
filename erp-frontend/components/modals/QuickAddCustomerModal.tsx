               ...
               <div className="space-y-4">
                 ...
                 <fieldset className="border border-[#1A1A1A] rounded bg-[#F8FAFC] p-4 relative pt-5 shadow-sm">
                   ...
                   <div className="grid grid-cols-[110px_1fr] gap-y-2.5 items-center text-xs">
                     ...
                     <label className="self-start mt-2 text-[#94a3b8]">Billing Address <span className="text-red-500">*</span></label>
                     ...
                     <label className="text-[#94a3b8]">State <span className="text-red-500">*</span></label>
