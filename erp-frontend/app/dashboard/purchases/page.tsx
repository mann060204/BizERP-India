                  ...
                  {purchases.map((pur) => {
                    ...
                    return (
                      <tr key={pur._id} className="hover:bg-[#F1F5F9] transition-colors group">
                        <td className="px-5 py-4 font-mono text-xs text-[#334155] font-semibold">{pur.billNumber}</td>
                        <td className="px-5 py-4 text-[#64748B]">{new Date(pur.billDate).toLocaleDateString('en-IN', { day: '2-digit', month: 'short', year: 'numeric' })}</td>
                        ...
                        <td className="px-5 py-4 text-[#64748B]">{pur.paymentMode}</td>
