...
export default function EditpurchaseReturnPage() {
    ...
    const fetchData = async () => {
      try {
        ...
        if (id) {
          ...
          const p = data.purchaseReturn;
          
          setpurchaseReturnType(p.purchaseReturnType || 'GST');
          ...
          setpurchaseReturnOrderNo(p.purchaseReturnOrderNo || '');
          if (p.purchaseReturnOrderDate) setpurchaseReturnOrderDate(new Date(p.purchaseReturnOrderDate).toISOString().split('T')[0]);
  ...
  const handleSave = async (saveStatus: 'draft' | 'received' | 'paid') => {
    ...
    try {
      ...
      await purchaseReturnsApi.update(id, payload);
      toast.success(`purchaseReturn Return ${billNumber} Updated!`);
  ...
  return (
    <div className="flex flex-col h-screen bg-slate-50 text-slate-900 font-sans overflow-hidden">
      <Topbar title="Edit purchaseReturn Return" />
        ...
        <div className="erp-container">
          ...
          <div className="p-1.5 space-y-1">
            <div className="grid grid-cols-[1fr_2fr_0.8fr_0.8fr_1fr_0.8fr_0.8fr_0.8fr_1fr_auto] gap-2 items-end">
              ...
              </div>{purchaseReturnType !== 'Non-GST' && (
                <>
                  <div>
