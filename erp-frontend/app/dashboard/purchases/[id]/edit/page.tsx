      ...
      <main className="flex-1 overflow-y-auto p-1 space-y-1 pb-14 bg-slate-50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2">
             ...
             <div className="erp-footer-box flex flex-col justify-between">
                ...
                {lastPrices.length > 0 && (
                  <div className="mt-2 w-full p-2 bg-yellow-50 border border-yellow-100 rounded text-[10px] text-yellow-800">
                     ...
                     {batches.map((b, i) => (
                       <tr key={i} className="text-xs hover:bg-slate-50">
                         ...
                         <td className="p-2 border border-slate-200 text-center flex justify-center gap-2">
                             <button onClick={() => { setBatchInput(batches[i]); setActiveTab('batches'); }} className="text-blue-500 hover:text-blue-700 p-1 bg-blue-50 rounded"><Pencil className="w-3.5 h-3.5" /></button>
