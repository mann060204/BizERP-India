              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-end gap-3 pt-4 pb-12 lg:pb-0">
                    <button onClick={() => router.push('/dashboard/customers')} className="px-6 py-2 rounded border border-[#1A1A1A] text-[#94a3b8] hover:text-white hover:border-[#D4D4D4] text-sm font-medium transition">Cancel</button>
