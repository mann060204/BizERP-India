...
import { customersApi, productsApi, quotationsApi, businessApi } from '../../../../../lib/erp-api';
...
export default function NewQuotationPage() {
  ...
  useEffect(() => {
    const init = async () => {
      try {
        ...
        setQuotationType(inv.quotationType || 'GST');
      ...
      <main className="flex-1 overflow-y-auto p-1 space-y-1 pb-14">
        ...
        <div className="erp-container flex-1 overflow-hidden flex flex-col min-h-[150px]">
           <div className="grid grid-cols-12 erp-grid-header border-b border-slate-200">
             ...
             {quotationType === 'GST' && <div className="col-span-1 erp-grid-cell text-center">Tax%</div>}
             {quotationType === 'GST' && <div className="col-span-1 erp-grid-cell text-center">Cess%</div>}
             <div className={`erp-grid-cell text-right ${quotationType === 'GST' ? 'col-span-1' : 'col-span-3'}`}>Total</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2">
           ...
           <div className="erp-footer-box space-y-2 col-span-2 flex flex-col">
              ...
              <div className="hidden grid grid-cols-1 md:grid-cols-2 gap-4 flex-1">
 ...
 disabled={saving} className="bg-primary hover:bg-primary-hover text-white px-4 py-1.5 rounded flex items-center gap-2 text-xs font-bold transition shadow-[0_0_15px_rgba(37,99,235,0.2)]">
