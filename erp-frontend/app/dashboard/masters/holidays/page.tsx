    ...
    <div className="flex flex-col h-screen">
      ...
      <main className="flex-1 p-6 flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-2xl font-bold dark:text-white text-gray-900 mb-2">Holiday Master</h2>
          <p className="dark:text-[#94a3b8] text-gray-600">Manage company holidays and non-working days.</p>
