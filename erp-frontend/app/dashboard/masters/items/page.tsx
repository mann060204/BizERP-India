            ...
            <div className="p-6 space-y-6 bg-[#F1F5F9]">
              ...
              <div className="p-4 rounded-xl border border-[#1e3a8a]/30 bg-white">
                 <div className="flex justify-between items-center mb-3">
                   ...
                   <div className="text-[11px] text-blue-400 font-semibold bg-primary/10 px-2 py-1 rounded-md border border-action-400/20">1 {form.unit || 'Pieces'} = {form.conversionRate || 1} {form.secondaryUnit || 'Feet'}</div>
                 </div>
