...
export default function Page() {
  ...
  const columns: any[] = [
    ...
    { key: 'totalPurchases', label: 'Total Purchases', align: 'right', format: (v: any) => `₹${Number(v||0).toFixed(2)}` },
    ...
    { key: 'totalPaid', label: 'Amount Paid', align: 'right', format: (v: any) => `₹${Number(v||0).toFixed(2)}` },
    { key: 'totalBalance', label: 'Balance', align: 'right', format: (v: any) => `₹${Number(v||0).toFixed(2)}` },
  ];
