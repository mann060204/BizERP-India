...
export default function Page() {
  ...
  const columns: any[] = [{ key: 'brand', label: 'Brand' },
  ...
  const fetchData = async () => {
    const res = await (reportsApi as any).getBrandWiseProfit();
  ...
  return (
    <ReportLayout
      title="Brand Wise Profit Report"
      subtitle="Analyze profitability by brand."
      category="Analytics"
      columns={columns}
      fetchData={fetchData}
