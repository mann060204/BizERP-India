...
export default function Page() {
  ...
  const columns: any[] = [
    ...
    { key: 'totalSales', label: 'Total Sales', align: 'right', format: (v: any) => `₹${Number(v||0).toFixed(2)}` },
    ...
    { key: 'totalReceived', label: 'Received', align: 'right', format: (v: any) => `₹${Number(v||0).toFixed(2)}` },
