...
const COUNTRY_CODES: Record<string, string> = {
  ...
  const handleSave = async () => {
    ...
    try {
      const payload = {
        ...
        contactPersonCode: form.contactPersonCode,
        pan: form.panNo,
        gstin: form.gstin,
  ...
  return (
    <div className="flex flex-col h-screen bg-slate-50 text-slate-900 font-sans overflow-hidden">
      <Topbar title="Supplier Information" />
            ...
            <div className="flex-1 grid grid-cols-1 lg:grid-cols-2 gap-4">
               ...
               <div className="space-y-4">
                 ...
                 <fieldset className="border border-slate-200 rounded bg-slate-50 p-4 relative pt-5 shadow-sm">
                   ...
                   <div className="mt-3 pl-[118px]">
                     <a href="#" className="text-primary text-[10px] hover:underline hover:text-blue-400 transition">Check GSTIN/UIN Status</a>
                   </div>
                 </fieldset>
               ...
               <div className="space-y-4">
                 ...
                 <div className="flex justify-end pt-4 pb-12 lg:pb-0">
                   <button onClick={handleSave} disabled={saving} className="bg-[#1e3a8a] hover:bg-primary-hover text-white px-8 py-2 rounded flex items-center gap-2 text-sm font-semibold shadow-md transition disabled:opacity-50">
