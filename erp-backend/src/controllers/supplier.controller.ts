...
// POST /api/v1/suppliers/:id/adjustments
...
// PUT /api/v1/suppliers/:id/ledger/:ledgerId
export const updateSupplierLedgerEntry = async (req: AuthRequest, res: Response): Promise<void> => {
  try {
    const businessId = req.user!.businessId;
...
// DELETE /api/v1/suppliers/:id/ledger/:ledgerId
export const deleteSupplierLedgerEntry = async (req: AuthRequest, res: Response): Promise<void> => {
  try {
    const businessId = req.user!.businessId;
    const { ledgerId } = req.params;
